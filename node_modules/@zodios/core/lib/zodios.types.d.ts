...
import { FilterArrayByValue, FilterArrayByKey, Merge, NeverIfEmpty, UndefinedToOptional, MapSchemaParameters, PathParamNames, SetPropsOptionalIfChildrenAreOptional, PickDefined, RequiredKeys, ReadonlyDeep, UndefinedIfNever, IfEquals } from './utils.types.js';
import z from 'zod';
...
type ZodiosPathParamsForEndpoint<Endpoint extends ZodiosEndpointDefinition, Frontend extends boolean = true, PathParameters = MapSchemaParameters<FilterArrayByValue<Endpoint["parameters"], {
    type: "Path";
}>, Frontend>> = NeverIfEmpty<{
    [K in PathParamNames<Endpoint["path"]>]: PathParameters extends {
        [Key in K]: any;
    } ? PathParameters[K] : string | number;
}>;
/**
 * Get path params for a given endpoint by path
 */
type ZodiosPathParamsByPath<Api extends ZodiosEndpointDefinition[], M extends Method, Path extends ZodiosPathsByMethod<Api, M>, Frontend extends boolean = true, PathParameters = MapSchemaParameters<FilterArrayByValue<ZodiosEndpointDefinitionByPath<Api, M, Path>[number]["parameters"], {
    type: "Path";
}>, Frontend>> = NeverIfEmpty<{
    [K in PathParamNames<Path>]: PathParameters extends {
        [Key in K]: any;
    } ? PathParameters[K] : string | number;
}>;
/**
 ...
 */
type ZodiosPathParamByAlias<Api extends ZodiosEndpointDefinition[], Alias extends string, Frontend extends boolean = true, EndpointDefinition extends ZodiosEndpointDefinition = ZodiosEndpointDefinitionByAlias<Api, Alias>[number], Path = EndpointDefinition["path"], PathParameters = MapSchemaParameters<FilterArrayByValue<EndpointDefinition["parameters"], {
    type: "Path";
}>, Frontend>> = NeverIfEmpty<{
    [K in PathParamNames<Path>]: PathParameters extends {
        [Key in K]: any;
 ...
 */
type ZodiosEndpointDefinition<R = unknown> = {
    /**
